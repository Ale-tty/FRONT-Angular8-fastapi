...
export class AuthService {
  ...
  login(email: string, password: string) {
    // let authResponseData = this.http.post<AuthResponseData>('https://crud-jinja2-fastapi.herokuapp.com/user/login', { email, password })
    return this.http.post<AuthResponseData>('https://crud-jinja2-fastapi.herokuapp.com/user/login', { email, password })
    .pipe(catchError(this.getErrorHandler), tap(this.handleUser.bind(this)));
  }
